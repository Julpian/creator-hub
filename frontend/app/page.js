...
export default function LandingPage() {
  return (
    ...
    bg-gradient-to-br from-[#1986DF] via-indigo-300 to-[#E0C3FC] 
    text-gray-900">
      {/* ===== Background Glows ===== */}
      ...
      {/* ===== Hero Section ===== */}
      <section className="relative w-full min-h-screen flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto px-6 pt-32 md:pt-40 gap-10">
        {/* Text Section */}
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="mt-5 text-gray-600 text-base md:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            Jangan hanya mengandalkan tools otomatis. Jadilah manusia dan bangun komunitas yang autentik —
            <b> Gen Creator Hub</b> membantu menghubungkan brand dengan kreator yang tepat melalui analisis data,
            tren, dan insight kreatif yang relevan untuk pertumbuhan bersama.
          </p>
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <Image
            src="/desain.svg"
            alt="Gen Creator Hero Illustration"
            width={600}
            height={500}
            className="w-[85%] md:w-[90%] object-contain drop-shadow-md"
            priority
          />
        </div>
      </section>
      ...
      {/* ===== Services Section ===== */}
      <section id="services" className="w-full py-24 bg-gradient-to-br from-white to-blue-50/30">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Core Services</h2>
          <p className="text-gray-600 max-w-2xl mx-auto mb-14">
            Kami menyediakan layanan terbaik untuk membantu brand dan kreator berkembang bersama dalam dunia digital yang dinamis.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-8 bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all text-center"
              >
                <h4 className="font-semibold text-xl text-gray-900 mb-3">{item.title}</h4>
